...
namespace btcm { namespace app {
   ...
   public:
      ...
      asset                              btcm_power; /// convert vesting_shares to vesting btcm
...
FC_REFLECT_DERIVED( btcm::app::extended_account,
                   (btcm::chain::account_object),
                   (btcm_power)
                   (transfer_history)(market_history)(vote_history)(other_history)
                   (witness_votes)(open_orders)(proposals) )


FC_REFLECT( btcm::app::vote_state, (voter)(weight)(rshares)(percent)(time) );
FC_REFLECT( btcm::app::account_vote, (authorperm)(weight)(rshares)(percent)(time) );

FC_REFLECT( btcm::app::state, (current_route)(props)(accounts)(pow_queue)(witnesses)(witness_schedule)(feed_price)(error)(market_data) )

FC_REFLECT_DERIVED( btcm::app::extended_limit_order, (btcm::chain::limit_order_object), (real_price)(rewarded) )
FC_REFLECT( btcm::app::order_history_item, (time)(type)(mbd_quantity)(btcm_quantity)(real_price) );
FC_REFLECT( btcm::app::market, (bids)(asks)(history)(price_history)(available_candlesticks)(available_zoom)(current_candlestick)(current_zoom) )
FC_REFLECT( btcm::app::candle_stick, (open_time)(period)(high)(low)(open)(close)(btcm_volume)(dollar_volume) );
