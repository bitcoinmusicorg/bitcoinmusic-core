...
#include <btcm/chain/streaming_platform_objects.hpp>
...
namespace btcm { namespace chain {
   ...
   class account_object : public abstract_object<account_object>
   {
      public:
         ...
         uint16_t        voting_power = BTCM_100_PERCENT;   ///< current voting power of this account, it falls after every vote
         time_point_sec  last_vote_time; ///< used to increase the voting power of this account the longer it goes without voting.

         asset           balance = asset( 0, BTCM_SYMBOL );  ///< total liquid shares held by this account
          ...
          *  BTCM_MIN_COMPOUNDING_INTERVAL_SECONDS has past since mbd_last_interest_payment then
         ...
         std::vector<share_type> proxied_vsf_votes = std::vector<share_type>( BTCM_MAX_PROXY_RECURSION_DEPTH, 0 ); ///< the total VFS votes proxied to this account
          ...
          *
          *  W = BTCM_BANDWIDTH_AVERAGE_WINDOW_SECONDS = 1 week in seconds
   ...
   typedef multi_index_container<
      ...
      indexed_by<
         ...
         >,
         ordered_unique< tag< by_btcm_balance >,
            composite_key< account_object,
...
FC_REFLECT( btcm::chain::account_object::redelegation, (redelegate_pct)(redelegated) )

FC_REFLECT_DERIVED( btcm::chain::account_object, (graphene::db::object),
...
FC_REFLECT_DERIVED( btcm::chain::vesting_delegation_object, (graphene::db::object),
                     (delegator)(delegatee)(vesting_shares)(min_delegation_time) )

FC_REFLECT_DERIVED( btcm::chain::vesting_delegation_expiration_object, (graphene::db::object),
                     (delegator)(vesting_shares)(expiration) )

FC_REFLECT_DERIVED( btcm::chain::owner_authority_history_object, (graphene::db::object),
                     (account)(previous_owner_authority)(last_valid_time)
                  )

FC_REFLECT_DERIVED( btcm::chain::account_recovery_request_object, (graphene::db::object),
                     (account_to_recover)(new_owner_authority)(expires)
                  )

FC_REFLECT_DERIVED( btcm::chain::change_recovery_account_request_object, (graphene::db::object),
                     (account_to_recover)(recovery_account)(effective_on)
                  )
FC_REFLECT_DERIVED( btcm::chain::account_balance_object, (graphene::db::object), 
