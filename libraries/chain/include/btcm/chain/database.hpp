...
#include <btcm/chain/node_property_object.hpp>
#include <btcm/chain/fork_database.hpp>
...
#include <btcm/chain/genesis_state.hpp>
...
namespace btcm { namespace chain {
   ...
   class database : public graphene::db::object_database
   {
      public:
          ...
          *
          * Passing slot_num == 0 returns BTCM_NULL_WITNESS
          */
          ...
          * first BTCM_MAX_VOTED_STREAMING_PLATFORMS streaming platforms by vote
          *
          */
         ...
         share_type claim_rshare_reward( share_type rshares, uint16_t reward_weight, asset max_btcm );
          ...
          * BTCM.  Return 0 SBD if there isn't a current_median_history
          */
         asset to_mbd( const asset& btcm )const;
         asset to_btcm(const asset &mbd)const;
   ...
   protected:
      ...
      private:
         ...
         fc::time_point_sec            _hardfork_times[ BTCM_NUM_HARDFORKS + 1 ];
         hardfork_version              _hardfork_versions[ BTCM_NUM_HARDFORKS + 1 ];
