...
FC_REFLECT_DERIVED( btcm::chain::operation_object, (graphene::db::object), (trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(op) )
FC_REFLECT_DERIVED( btcm::chain::account_history_object, (graphene::db::object), (account)(sequence)(op) )
