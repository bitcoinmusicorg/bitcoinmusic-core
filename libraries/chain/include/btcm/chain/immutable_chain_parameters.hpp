...
{
   uint16_t min_committee_member_count = BTCM_DEFAULT_MIN_COMMITTEE_MEMBER_COUNT;
   uint16_t min_witness_count = BTCM_DEFAULT_MIN_WITNESS_COUNT;
...
FC_REFLECT( btcm::chain::immutable_chain_parameters,
