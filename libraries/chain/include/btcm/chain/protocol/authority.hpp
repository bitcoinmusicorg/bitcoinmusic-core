 ...
 * - Length is between (inclusive) BTCM_MIN_ACCOUNT_NAME_LENGTH and BTCM_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

} } // namespace btcm::chain

FC_REFLECT( btcm::chain::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( btcm::chain::authority::classification, (owner)(active)(key)(basic) )
