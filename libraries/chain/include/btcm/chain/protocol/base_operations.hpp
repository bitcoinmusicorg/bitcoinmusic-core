#pragma once
#include <btcm/chain/protocol/base.hpp>
...
#include <btcm/chain/protocol/proposal.hpp>
#include <btcm/chain/protocol/btcm_operations.hpp>
#include <fc/utf8.hpp>
...
namespace btcm { namespace chain {
    ...
    * @ingroup operations
    *
    * @brief Transfers BTCM from one account to another.
    */
   ...
   /**
    *  This operation converts BTCM into VFS (Vesting Fund Shares) at
    ...
    * vests to btcm and back, guaranteeing they maintain their value.
    */
   ...
   {
      /**
       *  This fee, paid in BTCM, is converted into VESTING SHARES for the new account. Accounts
       *  without vesting shares cannot earn usage rations and therefore are powerless. This minimum
       *  fee requires all accounts to have some kind of commitment to the network that includes the
       *  ability to vote and make transactions.
       */
      asset             account_creation_fee =
            asset( BTCM_MIN_ACCOUNT_CREATION_FEE, BTCM_SYMBOL );

      asset             streaming_platform_update_fee =
            asset( BTCM_MIN_STREAMING_PLATFORM_CREATION_FEE, BTCM_SYMBOL );
      /**
       *  This witnesses vote for the maximum_block_size which is used by the network
       *  to tune rate limiting and capacity
       */
      uint32_t          maximum_block_size = BTCM_MIN_BLOCK_SIZE_LIMIT * 2;
      uint16_t          mbd_interest_rate  = BTCM_DEFAULT_SBD_INTEREST_RATE;
      extensions_type   extensions;
    ...
    *  used to define the exchange rate between btcm and the dollar.
    */
...
FC_REFLECT( btcm::chain::convert_operation, (owner)(requestid)(amount)(extensions) )
FC_REFLECT( btcm::chain::feed_publish_operation, (publisher)(exchange_rate)(extensions) )
FC_REFLECT( btcm::chain::chain_properties, (account_creation_fee)(streaming_platform_update_fee)(maximum_block_size)(mbd_interest_rate)(extensions) );

FC_REFLECT( btcm::chain::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( btcm::chain::account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( btcm::chain::account_update_operation,
            (account)
            (owner)
            (active)
            (basic)
...
FC_REFLECT( btcm::chain::transfer_operation, (from)(to)(amount)(memo)(extensions) )
FC_REFLECT( btcm::chain::transfer_to_vesting_operation, (from)(to)(amount)(extensions) )
FC_REFLECT( btcm::chain::withdraw_vesting_operation, (account)(vesting_shares)(extensions) )
FC_REFLECT( btcm::chain::set_withdraw_vesting_route_operation, (from_account)(to_account)(percent)(auto_vest)(extensions) )
FC_REFLECT( btcm::chain::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee)(extensions) )
FC_REFLECT( btcm::chain::account_witness_vote_operation, (account)(witness)(approve)(extensions) )
FC_REFLECT( btcm::chain::account_witness_proxy_operation, (account)(proxy)(extensions) )

FC_REFLECT( btcm::chain::custom_operation, (required_auths)(id)(data)(extensions) )
FC_REFLECT( btcm::chain::custom_json_operation, (required_auths)(required_basic_auths)(id)(json)(extensions) )
FC_REFLECT( btcm::chain::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration)(extensions) )
FC_REFLECT( btcm::chain::limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration)(extensions) )
FC_REFLECT( btcm::chain::fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) );
FC_REFLECT( btcm::chain::limit_order_cancel_operation, (owner)(orderid)(extensions) )


FC_REFLECT( btcm::chain::fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( btcm::chain::liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( btcm::chain::interest_operation, (owner)(interest) )
FC_REFLECT( btcm::chain::fill_vesting_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )

FC_REFLECT( btcm::chain::escrow_transfer_operation, (from)(to)(amount)(memo)(escrow_id)(agent)(fee)(json_meta)(expiration)(extensions) );
FC_REFLECT( btcm::chain::escrow_dispute_operation, (from)(to)(escrow_id)(who)(extensions) );
...
FC_REFLECT( btcm::chain::return_vesting_delegation_operation, (account)(vesting_shares)(extensions) )
