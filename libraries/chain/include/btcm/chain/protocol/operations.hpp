...
namespace fc {
    void to_variant( const btcm::chain::operation& var,  fc::variant& vo, uint32_t max_depth );
    void from_variant( const fc::variant& var,  btcm::chain::operation& vo, uint32_t max_depth );
}

FC_REFLECT_TYPENAME( btcm::chain::operation )
FC_REFLECT( btcm::chain::op_wrapper, (op) )
