...
#define BTCM_INIT_PUBLIC_KEY (btcm::chain::public_key_type(BTCM_INIT_PUBLIC_KEY_STR))
...
namespace fc
{
    void to_variant( const btcm::chain::public_key_type& var, fc::variant& vo, uint32_t max_depth = 2 );
    void from_variant( const fc::variant& var, btcm::chain::public_key_type& vo, uint32_t max_depth = 2 );
    void to_variant( const btcm::chain::extended_public_key_type& var, fc::variant& vo, uint32_t max_depth = 2 );
    void from_variant( const fc::variant& var, btcm::chain::extended_public_key_type& vo, uint32_t max_depth = 2 );
    void to_variant( const btcm::chain::extended_private_key_type& var, fc::variant& vo, uint32_t max_depth = 2 );
    void from_variant( const fc::variant& var, btcm::chain::extended_private_key_type& vo, uint32_t max_depth = 2 );
}

FC_REFLECT( btcm::chain::public_key_type, (key_data) )
FC_REFLECT( btcm::chain::public_key_type::binary_key, (data)(check) )
FC_REFLECT( btcm::chain::extended_public_key_type, (key_data) )
FC_REFLECT( btcm::chain::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( btcm::chain::extended_private_key_type, (key_data) )
FC_REFLECT( btcm::chain::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_ENUM( btcm::chain::object_type,
                 (null_object_type)
                 (base_object_type)
                 (OBJECT_TYPE_COUNT)
               )
FC_REFLECT_ENUM( btcm::chain::impl_object_type,
                 (impl_dynamic_global_property_object_type)
...
FC_REFLECT_TYPENAME( btcm::chain::share_type )
FC_REFLECT_TYPENAME( btcm::chain::operation_result )
FC_REFLECT_TYPENAME( btcm::chain::account_id_type )
FC_REFLECT_TYPENAME( btcm::chain::witness_id_type )
FC_REFLECT_TYPENAME( btcm::chain::streaming_platform_id_type )
FC_REFLECT_TYPENAME( btcm::chain::asset_id_type )
FC_REFLECT_TYPENAME( btcm::chain::dynamic_global_property_id_type )
FC_REFLECT_TYPENAME( btcm::chain::transaction_obj_id_type )
FC_REFLECT_TYPENAME( btcm::chain::block_summary_id_type )
FC_REFLECT_TYPENAME( btcm::chain::account_history_id_type )
FC_REFLECT_TYPENAME( btcm::chain::hardfork_property_id_type )
FC_REFLECT_TYPENAME( btcm::chain::proposal_id_type )
FC_REFLECT( btcm::chain::void_t, )
