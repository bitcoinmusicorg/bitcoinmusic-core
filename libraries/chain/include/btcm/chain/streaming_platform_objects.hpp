...
FC_REFLECT_DERIVED( btcm::chain::streaming_platform_object, (graphene::db::object),
                    (owner)
                    (created)
                    (url)(votes)
...
FC_REFLECT_DERIVED( btcm::chain::streaming_platform_vote_object, (graphene::db::object), (streaming_platform)(account) )

FC_REFLECT_DERIVED( btcm::chain::stream_report_request_object, (graphene::db::object), (requestor)(reporter)(reward_pct) )

FC_REFLECT_DERIVED( btcm::chain::report_object, (graphene::db::object), 
                    (streaming_platform)
                    (consumer)
                    (sp_user_id)
                    (content)
...
FC_REFLECT_DERIVED( btcm::chain::streaming_platform_user_object, (graphene::db::object),
