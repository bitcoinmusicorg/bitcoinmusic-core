...
namespace btcm { namespace chain {
   ...
   class witness_object : public abstract_object<witness_object>
   {
      public:
         ...
         time_point_sec    hardfork_time_vote = BTCM_GENESIS_TIME;
...
FC_REFLECT_DERIVED( btcm::chain::witness_object, (graphene::db::object),
                    (owner)
                    (created)
...
FC_REFLECT_DERIVED( btcm::chain::witness_vote_object, (graphene::db::object), (witness)(account) )

FC_REFLECT_DERIVED(
   btcm::chain::witness_schedule_object,
   (graphene::db::object),
