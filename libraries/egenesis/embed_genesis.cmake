...
if( ${embed_genesis_type} STREQUAL full )
...
endif( ${embed_genesis_type} STREQUAL full )

configure_file( "${CMAKE_CURRENT_SOURCE_DIR}/egenesis_${embed_genesis_type}.cpp.tmpl"
                "${CMAKE_CURRENT_BINARY_DIR}/egenesis_${embed_genesis_type}.cpp" )
