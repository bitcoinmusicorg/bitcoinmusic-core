...
#include <btcm/private_message/private_message_plugin.hpp>
...
using namespace btcm::private_message;
...
class wallet_api
{
   public:
     ...
     vector<proposal_object> get_proposed_transactions( string account_or_content )const;
       ...
       * @param amount The funds being transferred. i.e. "100.000 BTCM"
      ...
      /**
       * Transfer BTCM into a vesting fund represented by vesting shares (VESTS). VESTS are required to vesting
       * for a minimum of one coin year and can be withdrawn once a week over a two year withdraw period.
       * VESTS are protected against dilution up until 90% of BTCM is vesting.
       *
       * @param from The account the BTCM is coming from
       * @param to The account getting the VESTS
       * @param amount The amount of BTCM to vest i.e. "100.00 BTCM"
       * @param broadcast true if you wish to broadcast the transaction
       */
       ...
       *    withdrawn and deposited back as BTCM. i.e. "10.000000 VESTS"
       * @param broadcast true if you wish to broadcast the transaction
       */
       ...
       *
       * @param from The account the VESTS are withdrawn from.
       * @param to   The account receiving either VESTS or BTCM.
       ...
       *                       operations defined in `btcm/chain/operations.hpp`
      ...
      /**
       * Post a new content. TODO_BTCM update this
...
FC_REFLECT( btcm::wallet::wallet_data,
            (cipher_keys)
            (ws_server)
            (ws_user)
            (ws_password)
...
FC_REFLECT( btcm::wallet::brain_key_info, (brain_priv_key)(wif_priv_key) (pub_key))

FC_REFLECT_DERIVED( btcm::wallet::signed_block_with_info, (btcm::chain::signed_block),
   (block_id)(signing_key)(transaction_ids) )

FC_REFLECT( btcm::wallet::operation_detail, (memo)(description)(op) )
FC_REFLECT( btcm::wallet::plain_keys, (checksum)(keys) )

FC_REFLECT_ENUM( btcm::wallet::authority_type, (owner)(active)(basic) )

FC_API( btcm::wallet::wallet_api,
        /// wallet api
        (help)(gethelp)
...
FC_REFLECT( btcm::wallet::approval_delta,
...
FC_REFLECT( btcm::wallet::memo_data, (from)(to)(nonce)(check)(encrypted) )
