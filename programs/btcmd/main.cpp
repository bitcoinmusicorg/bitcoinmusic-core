...
int main(int argc, char** argv) {
   btcm::plugin::initialize_plugin_factories();
   ...
   try {
      ...
      for( const std::string& plugin_name : btcm::plugin::get_available_plugins() )
         node->register_abstract_plugin( btcm::plugin::create_plugin( plugin_name ) );
