...
//var BTCM_100_PCT = 100000;
var BTCM_100_PCT = 10000;

//var TOTAL_INFLATION = 1;
var TOTAL_INFLATION = .0475;

var MAX_MULT = Math.pow(2,64) / BTCM_100_PCT;
...
function calc_constants( steps ) {
    var multiplier = Math.expm1(Math.log1p(TOTAL_INFLATION) / steps) / BTCM_100_PCT;
    var shift = 0;
...
Object.keys(WANTED).forEach(function (key) {
    ...
    console.log("#define BTCM_APR_PERCENT_MULTIPLY_PER_" + key + " (0x" + result[0].toString(16) + "ULL)");
    console.log("#define BTCM_APR_PERCENT_SHIFT_PER_" + key + " " + result[1]);
});
