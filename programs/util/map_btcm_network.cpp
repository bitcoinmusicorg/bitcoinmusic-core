...
public:
  ...
  void start(const fc::ip::endpoint& endpoint_to_probe,
             ...
             const btcm::chain::digest_type& chain_id)
  {
    ...
    user_data["chain_id"] = BTCM_CHAIN_ID;
    graphene::net::hello_message hello("map_btcm_network",
...
int main(int argc, char** argv)
{
  ...
  fc::path data_dir = fc::temp_directory_path() / "map_btcm_network";
  fc::create_directories(data_dir);

  fc::ecc::private_key my_node_id = fc::ecc::private_key::generate();
  btcm::chain::database chain_db;
